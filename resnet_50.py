...
def resnet50_model(img_rows, img_cols, color_type=3, num_classes=1):
    """
    ...
    x = Conv2D(64, (7, 7), strides=(2, 2), name='conv1_new')(x)
    x = BatchNormalization(axis=bn_axis, name='bn_conv1_new')(x)
    x = Activation('relu')(x)
