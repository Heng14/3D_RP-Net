...
from brats.train_siam import config
...
def get_image(subject_folder, name0):

    if name0 == 't1':
        name = '_oax_hr_t1_fse'
    elif name0 == 't1c':
        name = '_oax_hr_t1_fsec'
    elif name0 == 't2':
        name = '_oax_hr_t2_fse'
    elif name0 == 'dwi':
        name = '_hr_dwi*'
...
def convert_brats_folder(in_folder, out_folder, truth_name='seg', no_bias_correction_modalities=None):
    ...
    truth_name = os.path.basename(in_folder)
    print (f'processing {truth_name} ...')
    ...
    # copy the truth file
    try:
        truth_file = get_truth_image(in_folder, truth_name)
    except RuntimeError:
        truth_file = get_truth_image(in_folder, truth_name.split("_")[0])
...
if __name__ == '__main__':
    convert_brats_data("twostage_data_300/original", "twostage_data_300/preprocessed")
